        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <address class="mb-0 text-center">
              ...
              <?php endif; ?>
              <?php if ($customer['customer_formula']) : ?>
              <p>
                <b>
                  Formula
                </b> 
                <?php echo $customer['customer_formula']; ?>
                <button class="btn btn-default buttons-print button-print-formula" tabindex="0" aria-controls="invoice-invoice-list" type="button" title="Print"><span><i class="fa fa-print"></i></span></button>
              </p>
              <?php endif; ?>
              <?php if ($customer['dob']) : ?>
                <p>
...
<script type="text/javascript">
  ...
  var customerFormula = '<?php echo $customer['customer_formula']; ?>';
</script>
<script> 
$(".button-print-formula").on('click', function(){
  console.log('works')
  var winPrint = window.open('','','left=0, top=0, width=800, height=600, tollbar=0, scrollbars=0, status=0');
  winPrint.document.write(`<title> Formula</title><br/><br/>Cliente: ${customerName} <br> Formula: ${customerFormula}`);
