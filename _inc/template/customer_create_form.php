<form id="create-customer-form" class="form-horizontal" action="customer.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <label for="customer_formula" class="col-sm-3 control-label">
        Formula
      </label>
      <div class="col-sm-7">
        <input type="text" class="form-control" id="customer_formula" value="<?php echo isset($request->post['customer_formula']) ? $request->post['customer_formula'] : null; ?>" name="customer_formula">
      </div>
    </div>
